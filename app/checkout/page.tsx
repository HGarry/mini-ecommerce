...
export default function CheckoutPage() {
  ...
  if (!isMounted) return <div className="min-h-[60vh] w-full" aria-busy="true" />;
  ...
  if (isPlaced) {
    return (
      <div className="flex min-h-[70vh] w-full items-center justify-center p-4">
        <section className="w-full max-w-lg rounded-2xl border border-emerald-200 bg-white p-6 text-center shadow-sm sm:p-8">
  ...
  return (
    <div className="w-full min-w-0 box-border bg-slate-50 px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-6xl flex flex-col gap-8 lg:gap-12">
        <Link
          href="/cart"
        ...
        <div className="">
          <form onSubmit={handleSubmit} className="w-full min-w-0 space-y-6">
            <section className="w-full min-w-0 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-7">
              <div>
              ...
              <div className="mt-6 grid w-full min-w-0 gap-4 sm:grid-cols-2 sm:gap-5">
                <Field
                  label="Full name"
            ...
            <section className="w-full min-w-0 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-7">
              ...
              <div className="mt-4 space-y-3">
                {deliveryOptions.map((option) => (
                  <label
                    key={option.id}
                    className={`flex cursor-pointer items-center justify-between gap-2 rounded-xl border p-3 transition sm:gap-4 sm:p-4 ${
                  ...
                  >
                    <span className="flex min-w-0 items-center gap-3">
                      <input
                        ...
                        className="size-4 shrink-0 accent-fuchsia-600"
                      />
          ...
          <aside
            className="w-full rounded-xl border border-gray-200 bg-white p-4 text-gray-900 shadow-sm lg:sticky lg:top-6 sm:p-6"
  ...
  return (
    <label className="block w-full text-xs font-semibold text-slate-700 sm:text-sm">
      ...
      <input
        ...
        className={`mt-1.5 w-full rounded-lg border bg-white px-3 py-2.5 font-normal text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-fuchsia-500 focus:ring-2 focus:ring-fuchsia-100 ${
